...
namespace WebApplication452_simple.Controllers
{
    public class HotelsController : Controller
    {
        ...
        public ActionResult Create([Bind("Id", "Name", "CountryId", "City", "Stars", "PricePerNight", "IsAllInclusive")] Hotel hotel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind("Id", "Name", "CountryId", "City", "Stars", "PricePerNight", "IsAllInclusive")] Hotel hotel)
        {
            if (ModelState.IsValid)
            {
