...
namespace new_app.Controllers
{
    public class HotelsController : Controller
    {
        ...
        // Constructor-based dependency injection instead of direct instantiation
        ...
        {
            // Using async/await pattern for better scalability
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // Using async/await with FirstOrDefaultAsync instead of Find
            // Including Country data for the view
        ...
        {
            // Using ViewData instead of ViewBag
