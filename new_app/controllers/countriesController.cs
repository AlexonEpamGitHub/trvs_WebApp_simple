...
namespace NewApp.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Region")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Region")] Country country)
        {
            if (id != country.Id)
            {
                return NotFound();
